...
export const metadata: Metadata = {
  ...
  description:
    "The first five issues of Middlegame Weekly, tracking the public signals behind the Agency Era thesis.",
  alternates: {
    ...
    <div style={{ background: "var(--bg-primary)" }} className="min-h-screen">
      <main className="mx-auto max-w-3xl px-6 py-20 md:py-32">
        ...
        <div className="max-w-2xl">
          ...
          >
            Five weekly intelligence memos tracking the public signals behind the Agency Era
            thesis: power, compute, infrastructure, commodities, and capital allocation.
          </p>
        </div>
